  ...
  return (
    ...
    >
      <Link to={`/brand/${brand.slug}`} className="group block">
        <div className="relative overflow-hidden rounded-xl bg-secondary" style={{ aspectRatio: "3/2" }}>
          <img
            src={brand.banner}
            alt={brand.name}
            loading="lazy"
          ...
          <div className="absolute bottom-0 left-0 p-5">
            <h3 className="font-display text-lg font-bold text-white">{brand.name}</h3>
